...
Cifar10CorruptedTrain is a dataset generated by adding 15 common corruptions + 4
extra corruptions to the train images in the Cifar10 dataset. This dataset wraps
the corrupted Cifar10 train images uploaded by the original authors.
"""
...
_MANUAL_FILENAME = 'Cifar10CTrain.zip'
...
class Cifar10CorruptedTrain(tfds.core.GeneratorBasedBuilder):
  """Corrupted Cifar10 dataset."""
  VERSION = tfds.core.Version('1.0.0')
  RELEASE_NOTES = {
  ...
  MANUAL_DOWNLOAD_INSTRUCTIONS = """
   Place the `Cifar10CTrain.zip`
   file in the `manual_dir/`. Default localtion is: tensorflow_datasets/downloads/manual
   """
  ...
  def _split_generators(self, dl_manager):
    ...
    path = dl_manager.extract(os.path.join(dl_manager.manual_dir,_MANUAL_FILENAME))
