...
@gin.configurable
def gen_pipeline_train_baseline(ds_name='cifar10',
    ...
    # if augmentation type == batch, then apply batch aug
    if augmentation_type == 'batch':
...
@gin.configurable
def gen_pipeline_eval_baseline(ds_name='mnist',
                               tfds_path='~/tensorflow_datasets',
                               size_batch=100,
                               size_buffer_cpu=5,
                               dataset_cache=False,
...
@gin.configurable
def gen_pipeline_test_baseline(ds_name='cifar10',
                      tfds_path='',
                      size_batch=100,
                      size_buffer_cpu=5,
                      dataset_cache=False,
