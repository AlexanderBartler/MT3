import logging
from model.inputs.input_fn_baseline import gen_pipeline_test_baseline
from model import model_fn, test_baseline
...
def run_test(dataset='', run_paths=''):
    ...
    test_ds, test_info = gen_pipeline_test_baseline(ds_name=dataset)
    ...
    result = test_baseline.test_baseline(model, test_ds, test_info, run_paths)
    return result
